...
/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called Uni that contains them all. This will be an array of objects. Log the result. */
const uni = [];
...
*/
const displayNames = [];
 zooAnimals.forEach(Zoofunction)

 function Zoofunction(item){
  let name = item.animal_name + " " + item.scientific_name;
  displayNames.push(name);
 } 
console.log(JSON.stringify(displayNames));
